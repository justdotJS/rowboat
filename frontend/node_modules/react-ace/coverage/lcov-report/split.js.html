...
&nbsp;
    ...
    split.forEach((editor, index) =&gt; {
      ...
      e</span>ditor.setValue(defaultValueForEditor === undefined ? valueForEditor : <span class="branch-1 cbranch-no" title="branch not covered" >defaultValueForEditor, cursorStart);
...
&nbsp;
    if (nextProps.orientation !== oldProps.orientation) {
      split.setOrientation( n</span>extProps.orientation === 'below' ? <span class="branch-0 cbranch-no" title="branch not covered" >split.BELOW : split.BESIDE);
    }
&nbsp;
    split.forEach((editor, index) =&gt; {
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Aug 23 2017 01:20:47 GMT+0000 (UTC)
</div>
</div>
